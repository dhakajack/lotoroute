...
const DEPARTMENT_GEO: Record<string, GeoNodeInput> = {
  ...
  "06": { latitude: 43.898, longitude: 7.1052, population: 1128418, neighbors: ["04", "83"] },
  ...
  "13": { latitude: 43.4425, longitude: 5.1505, population: 2087658, neighbors: ["30", "83", "84"] },
  ...
  "2A": { latitude: 41.8396, longitude: 8.9396, population: 168306, neighbors: ["2B"] },
  "2B": { latitude: 42.4916, longitude: 9.1344, population: 187180, neighbors: ["2A"] },
  ...
  "62": { latitude: 50.3962, longitude: 2.4765, population: 1457905, neighbors: ["59", "80"] },
  ...
  "83": { latitude: 43.3325, longitude: 6.2536, population: 1119307, neighbors: ["04", "06", "13", "84"] },
...
const COUNTRY_GEO: Record<string, GeoNodeInput> = {
  ...
  CY: { latitude: 35.1856, longitude: 33.3823, population: 1260000, neighbors: [] },
  ...
  DK: { latitude: 55.6761, longitude: 12.5683, population: 5960000, neighbors: ["D", "S"] },
  ...
  GB: { latitude: 51.5072, longitude: -0.1276, population: 68300000, neighbors: ["IRL", "UK"] },
  GR: { latitude: 37.9838, longitude: 23.7275, population: 10400000, neighbors: ["BG"] },
  ...
  I: { latitude: 41.9028, longitude: 12.4964, population: 58900000, neighbors: ["04", "05", "06", "73", "74", "A", "CH", "MC", "RSM", "SLO", "V"] },
  IRL: { latitude: 53.3498, longitude: -6.2603, population: 5300000, neighbors: ["GB", "UK"] },
  IS: { latitude: 64.1466, longitude: -21.9426, population: 390000, neighbors: [] },
  ...
  M: { latitude: 35.8997, longitude: 14.5146, population: 540000, neighbors: [] },
  ...
  UK: { latitude: 51.5072, longitude: -0.1276, population: 68300000, neighbors: ["GB", "IRL"] },
